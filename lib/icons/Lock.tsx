...
const Lock: FC<IconProps> = ({className = ''}) => {
	return <svg xmlns="http://www.w3.org/2000/svg" className={className} width="20" height="20" viewBox="0 0 20 20"
	            fill="none">
		<path
			...
			stroke="#FFC800" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
		<path
